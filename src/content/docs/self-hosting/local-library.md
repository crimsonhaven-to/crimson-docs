...
description: Browse, search and play your own on-disk media as a first-class surface, covering the Index's "Local" view, filename/metadata indexing, per-title overviews and watch progress.
---
...
- **Local results in search.** The site-wide search now also queries your library, so
...
Unlike the online surfaces, the library reads **only your own disk**, and there are no
...
Local source at a copy of your cache just works, and you get a browsable shelf of
everything you've cached.
:::
...
a **movie**. Episodes are grouped into seasons, and the parser understands `S01E02`,
